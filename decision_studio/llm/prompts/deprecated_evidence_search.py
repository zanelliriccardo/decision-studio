...
grounder builds its queries inline rather than from a prompt module.

Renamed rather than deleted so that anyone reinstating prompt-driven
search finds the previous attempt instead of writing it again.
